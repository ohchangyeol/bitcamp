...
public class Iam01 extends Human01{
	...
	///Constructor
	public Iam01(){
		//this(); constructor이 recursive 되기때문에 안됨.
		//super()가 없어도 일단 명시적으로 default 되있다.
		super(); 
        System.out.println("Iam class default Constructor = 1");
	}
	public Iam01(String str){
		//super();
		System.out.println("Iam class의 String 인자를 받는 Constructor = 1");
		job = str;
	}
